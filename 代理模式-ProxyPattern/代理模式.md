...
![image-20220105095926254](/Users/wangshanpeng/Library/Application Support/typora-user-images/image-20220105095926254.png)



### 两者区别

1、**Jdk动态代理**：利用拦截器（必须实现InvocationHandler接口）加上**反射机制**生成一个代理接口的匿名类，在调用具体方法前调用InvokeHandler来处理

2、 **Cglib动态代理**：利用ASM框架，对代理对象类生成的class文件加载进来，通过**修改其字节码生成子类来进行代理**
